...
def price():
        ...
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Pani Puri",
        fg="#ED420B", anchor=W)
        lblinfo.grid(row=3, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="15",
        fg="#ED420B", anchor=W)
        lblinfo.grid(row=3, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Puran Poli",
        fg="#ED420B", anchor=W)
        ...
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Paneer Masala",
        fg="#ED420B", anchor=W)
        ...
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Shrikhand",
        fg="#ED420B", anchor=W)
        lblinfo.grid(row=7, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="10",
        fg="#ED420B", anchor=W)
        lblinfo.grid(row=8, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Cofiee",
        fg="#ED420B", anchor=W)
...
heading1=Label(root,text="Prachi's Restaurant",font="arial 30 bold",fg="#fc5a03")
heading2=Label(root,text="Welcome in Restaurant",font="arial 18 bold",fg="#fc5a03")
...
#Frame1_objects
drink_label=Label(frame1,text="Tea",font="arial 12 bold ",bg="#ED420B")
burger_king_label=Label(frame1,text="Cofiee",font="arial 12 bold",bg="#ED420B")
cherry_label=Label(frame1,text="Water",font="arial 12 bold",bg="#ED420B")
nacho_fries_label=Label(frame1,text="Pani Puri",font="arial 12 bold",bg="#ED420B")
pizza_label=Label(frame1,text="Burger",font="arial 12 bold ",bg="#ED420B")
biscuits_label=Label(frame1,text="Panner Masala",font="arial 12 bold",bg="#ED420B")
roll_label=Label(frame1,text="Puran Poli",font="arial 12 bold ",bg="#ED420B")
tea_label=Label(frame1,text="Shrikhand",font="arial 12 bold ",bg="#ED420B")
